          ...
          >
            <div className='w-full flex flex-col lgl:flex-row gap-4 lgl:gap-10 justify-between'>
              <input
                ...
                value={clientName}
                className={`${
                  errClientName ? 'border-red-600 focus-visible:border-red-600' : 'border-zinc-600 focus-visible:border-designColor'
              ...
              <input
                ...
                value={email}
                className={`${
                  errEmail ? 'border-red-600 focus-visible:border-red-600' : 'border-zinc-600 focus-visible:border-designColor'
                } w-full bg-transparent border-2 px-4 py-2 text-base text-gray-200 outline-none duration-300`}
                type='email'
